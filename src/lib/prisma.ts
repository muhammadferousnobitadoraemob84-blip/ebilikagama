...
const CORRECT_DB_URL = `postgresql://neondb_owner:npg_skDMx4A5GQzV@${CORRECT_DB_HOST}/neondb?sslmode=require&connect_timeout=5&pool_timeout=5`; // eslint-disable-line no-secrets -- see note above
