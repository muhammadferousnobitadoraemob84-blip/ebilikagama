    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-400">Memuatkan saluran...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              ...
              {channel.liveStatus === "live" ? (
                <span className="bg-red-600 text-white text-xs font-bold px-2.5 py-1 rounded-md flex items-center gap-1.5">
                  <span className="w-2 h-2 bg-white rounded-full animate-pulse" />
                  LIVE
                </span>
              ) : (
                <span className="bg-gray-600/80 text-gray-200 text-xs font-medium px-2.5 py-1 rounded-md">
                  OFFLINE
                </span>
              )}
            </div>
