  ...
  return (
    <div className="min-h-screen bg-gray-950">
        ...
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              {/* Owner badge */}
              {user && (
                <span className="hidden sm:inline-flex items-center gap-1.5 bg-red-600/10 border border-red-600/20 text-red-400 text-xs font-medium px-3 py-1.5 rounded-full">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside
          className={`fixed lg:sticky top-16 left-0 h-[calc(100vh-4rem)] w-64 bg-gray-950 border-r border-white/10 z-40 transform transition-transform duration-300 ${
